...
//  PlayingCard
//
//  Created by Swift iOS on 2/2/18.
...
class PlayingCardView: UIView {
    ...
    private func centuredAttributedString(_ string: String, fontSize: CGFloat) -> NSAttributedString
    {
    ...
    private var cornerString: NSAttributedString {
        return centuredAttributedString(rankString+"\n"+suit, fontSize: cornerFontSize)
    }
